...
### Project Overview
The `compliance-review/` directory (on the `cursor/product-design-doc-6f9d` branch) contains a Spring Boot 3.2.5 (Java 21) backend for an intelligent compliance review system. It uses MySQL 8 as its sole data store and a mock LLM model for MVP.
